                         ...
                         <div className="grid grid-cols-2 gap-3">
                              ...
                              <div>
                                   ...
                                   <div className="relative">
                                        <select
                                             className="h-9 w-full appearance-none rounded border border-[#d9d9e4] transition ease-in bg-white px-3 pr-8 text-[11px] text-gray-600 outline-none focus:border-[#6558e6]"
                                        >
                    ...
                    <div className="rounded-md border border-[#dedee8] bg-white p-4 shadow-sm">
                         ...
                         <div className="grid grid-cols-2 gap-3">
                              ...
                              <div>
                                   ...
                                   <div className="relative">
                                        <select
                                             className="h-9 w-full appearance-none rounded border border-[#d9d9e4] bg-white px-3 pr-8 text-[11px] text-gray-600 outline-none focus:border-[#6558e6]"
                                        >
                         ...
                         <div className="mt-3">
                              ...
                              <div className="flex min-h-9 flex-wrap items-center gap-1 rounded border border-[#d9d9e4] bg-white px-2 py-1.5">
                                   ...
                                   {/* Beach Badge */}
                                   <span className="inline-flex items-center gap-1 rounded-full bg-[#e8eafa] px-2.5 py-1 text-[9px] font-medium text-[#5146e5] transition-all duration-200 hover:bg-[#dfe1f8]">
                                        Beach

                                        <FontAwesomeIcon
                                             icon={faXmark}
                                             className="cursor-pointer text-[8px] text-[#5146e5] transition-colors duration-150 hover:text-red-500"
                                        />
                                   </span>
                                   ...
                                   {/* Add Tag */}
                                   <span className="cursor-pointer rounded-full px-2 py-1 text-[10px] text-gray-400 transition-colors duration-200 hover:bg-gray-100 hover:text-gray-600">
                                        Add tag...
                                   </span>
