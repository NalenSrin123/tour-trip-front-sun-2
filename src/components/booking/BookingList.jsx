      ...
      <div className="container-bookingList p-10 w-full bg-gray-100">
        ...
        <table className="w-full mt-10 border-[1px] border-gray-200  border-collapse table-fixed">
          ...
          <tbody>
            <tr className="bg-white">
              ...
              <td className="p-3">
                <p className="bg-amber-100 rounded-md text-center">Paid</p>
              </td>

              <td className="p-3 ">
                <p className="bg-blue-500 text-center rounded-md">Confirmed</p>
              </td>
            </tr>
            <tr className="bg-white">
              ...
              <td className="p-3">
                <p className="bg-yellow-200 rounded-md text-center">PENDING</p>
              </td>

              <td className="p-3 ">
                <p className="bg-yellow-200 text-center rounded-md">PENDING</p>
              </td>
            </tr>
            <tr className="bg-white">
              <td className="p-3">#BKG-8892</td>
        ...
        <div className="flex justify-between items-center bg-white py-4 px-4 rounded-[0px 0px 5px 5px]">
          ...
          <div className="list mr-4 flex items-center border-gray-400">
            ...
            <button className="w-[32px] border-[1px] border-gray-400 py-1 bg-blue-600">
              1
            </button>
            <button className="w-[32px] border-[1px] border-gray-400 py-1">
              2
            </button>
            <button className="w-[32px] border-[1px] border-gray-400 py-1">
              3
